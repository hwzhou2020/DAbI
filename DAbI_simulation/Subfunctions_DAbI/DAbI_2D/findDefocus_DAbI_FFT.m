function z = findDefocus_DAbI_FFT(overlap_crop_all, angles_sep, xsize, dpix_c, z_est, z_threshold_low, mag, na_illu,na_obj, sub_pixel_resolve, z_shift, defocus_level)
...
for n_multi = 1:nBrightField_multi
    ...
    if z_shift == 0  % large defocus distance
        Nk = xsize * dpix_c / (z_est*0.5) / mag / na_illu / sin(angles_sep(1))/2;
