...
for sample_idx = 1:length(folder_name)
    ...
    count = 1;
    zlist = [0:5:50,60:10:400,425:25:600];
    for z_pos = zlist
        ...
        tic
        z_defocus = findDefocus_DAbI_3D(imlow_defocus, freqXY_calib, CTF, na_illu, na_obj, wavelength, mag, dpix_c, sub_pixel_resolve,use_GPU);
        toc
